...
inline struct WorkingSetElement* env_page_ws_list_create_element(struct Env* e, uint32 virtual_address)
{
	...
	ptr_WS_element =(struct WorkingSetElement*) kmalloc(sizeof(struct WorkingSetElement));
	 if(ptr_WS_element==NULL)
			panic("HELP");
	 ptr_WS_element->virtual_address=virtual_address;
	 ptr_WS_element->prev_next_info.le_next=NULL;
	 ptr_WS_element->prev_next_info.le_prev=NULL;
